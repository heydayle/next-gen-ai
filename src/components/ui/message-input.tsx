    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="bg-background text-muted-foreground absolute left-1/2 flex -translate-x-1/2 overflow-hidden whitespace-nowrap rounded-full border py-1 text-center text-sm"
        >
